/**
 * SyncAllSheets.js
 * Sincroniza las pestañas resumen '(All)' desde el origen al destino,
 * preservando comentarios, status y registrando cambios en Change Log.
 */

function syncAllSummarySheets() {
  ...
  var sheetsToSync = CONFIG.ALL_SHEETS_TO_SYNC;
  var logEntries = [];
  ...
  Logger.log("¡Sincronización de pestañas resumen '(All)' completada!");
}
